...
final class DascadeWeb implements DascadeFramework {
  ...
  static Future<void> execute(final DascadeApp app) async {
    late final DascadeWeb d;
    await runZonedGuarded(() async {
      d = DascadeWeb._internal();
      await app(d);
    ...
    }, (final Object error, final StackTrace stack) async {
      // ignore: avoid_print
      print('DASCADE APPLICATION FATAL ERROR');
      // ignore: avoid_print
      print(error);
      // ignore: avoid_print
      print(stack);
  ...
  /// Sidecar is not supported on web-based platforms. You can just use developer tools to see your print() statements.
  @override
